...
class LwhhSocialIcons_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Lwhh: Social Icons', 'jurist' ), // Name
            array( 'description' => __( 'Social Icons', 'jurist' ), ) // Args
        );
    }
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'jurist' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"
                   name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text"
                   value="<?php echo esc_attr( $title ); ?>"/>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'classname' ) ); ?>"><?php _e( 'CSS Class name:', 'jurist' ); ?></label>
        ...
        <?php foreach ( $social_icons as $sci ) {
            ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( $sci )) ; ?>"><?php echo esc_html( ucfirst( $sci ) . " " . __( 'URL', 'jurist' ) ); ?>
                    : </label>
                <br/>
